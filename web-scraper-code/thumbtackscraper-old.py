# python3 thumbtackscraper-old.py links.txt
'''
...
NAME_PATH = "//h1[contains(@class, '_2INzsKazlBi3MJm_ZwDMhG _23PifmaL2cIG8rDO-YARRs')]"
            ...
            try:    
                ...
                if 'html' in head.headers['content-type']:
                    ...
                    if response.status_code == 200:
                        ...
                        contractor_name = driver.find_element(By.XPATH, NAME_PATH).text
